            ...
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <button type="reset" class="btn btn-danger btn-sm float-right mr-1"><i class="fas fa-times"></i> Reset</button> 
                            ...
                            <div class="row">
                                ...
                                <input type="text" name="barcode" class="form-control" id="barcode" autocomplete="off" autofocus required>
                                </div>
                                ...
                                <input type="number" name="harga_juak" class="form-control" id="harga_jual" placeholder="Rp 0" autocomplete="off" required>
                                </div>
                            ...
                            <img src="<? $main_url ?> asset/image/..." class="profile-user-img mb-3 mt-4" alt=""> 
