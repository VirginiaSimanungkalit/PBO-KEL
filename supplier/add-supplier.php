...
<div class="content-wrapper">
  ...
  <?php if ($alert != '') {
    ...
    <div class="form-group">
      ...
      <input type="text" name="telpon" class="form-control" id="telpon" placeholder="no telepon supplier" pattern="[0-9] {5, }" title="minimal 5 angka" required>
    </div>
    <div class="form-group">
      <label for="ketr">Deskripsi</label>
      <textarea name="ketr" id="ketr" rows="1" class="form-control" placeholder="Keterangan suplier" required></textarea>
    </div>
    <div class="form-group">
      <label for="alamat">Alamat</label>
      <textarea name="alamat" id="alamat" rows="3" class="form-control" placeholder="Alamat suplier" required></textarea>
    </div>
  </div>
</div>
</form>
